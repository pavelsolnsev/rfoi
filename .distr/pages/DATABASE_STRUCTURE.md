...
- `yellow_cards` - INT, DEFAULT 0 (Количество желтых карточек, накапливается)
...
**Особенности**:
- Один игрок может играть за разные команды (каждая комбинация team_id + player_id уникальна)
- Если игрок уже играл за эту команду, `tournament_count` увеличивается на 1
- Если игрок играет за команду впервые, создается новая запись с `tournament_count = 1`
