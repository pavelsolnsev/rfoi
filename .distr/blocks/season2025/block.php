        ...
        <tbody id="desktop-table-body">
          ...
          <?php else: ?>
            <?php foreach ($players as $index => $player): ?>
              ...
              ?>
              <tr class="player-row" data-player='<?= json_encode($player, JSON_UNESCAPED_UNICODE | JSON_HEX_APOS) ?>'>
                ...
                <td data-label="Игры"><?= $gamesPlayed ?></td>
                <td data-label="Победы"><?= $wins ?></td>
                <td data-label="Ничьи"><?= $draws ?></td>
                <td data-label="Поражения"><?= $losses ?></td>
                <td data-label="Голы"><?= $goals ?></td>
